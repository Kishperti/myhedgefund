      ...
      <div className={`${styles.bg} ${styles.rounded} ${herolineText.className} relative`}>
        <div className={`${styles.hero} flex flex-col items-center justify-center`}>
          ...
          <p className={`m-auto  text-[#DBDBDB] text-[24px] font-sans ${styles.quote} text-center`}>
            "Insights and trends for savy investors and market watchers."
          </p>
...
<button
      ...
      <div className={`${styles.intro}`}>
        ...
        <br />
        Hedgemyfunds is a India based private equity management firm that provides Contracted Investment Management Services and Cash Management Services for Corporate Clients and Consumer Clients. <br />
        <br />
        <br />
