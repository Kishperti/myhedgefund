      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-center mt-10">
            <span>
              <Typewriter className='m-auto text-[#DBDBDB] font-sans'
                options={{
                  strings: ["<span style='font-size: 55px; font-weight: bold;'>Personalized Assistance</span>", "<span style='font-size: 55px; font-weight: bold;'>Get in Touch</span>", "<span style='font-size: 55px; font-weight: bold;'>Financial Help</span>"],
                  autoStart: true,
                  loop: true,
                }}
              />
          ...
          <Link href="/join-us">
            <button
              className="bg-black text-white py-2 px-4 border-2 border-white rounded mt-8 "
              id="getStartedButton"
            >
